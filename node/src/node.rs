...
use crate::{
    ...
    consensus::{
        ...
        election_schedulers::{
            ElectionSchedulers, ElectionSchedulersPlugin, SchedulerWakePolicy, SchedulerWakeSignal,
        },
...
impl Node {
    ...
    fn new(args: NodeArgs, is_nulled: bool, mut node_id_key_file: NodeIdKeyFile) -> Self {
        ...
        let scheduler_wake_policy = Arc::new(SchedulerWakePolicy::new(scheduler_wakeup.clone()));

        let active_elections = Arc::new(AecService::new(
            config.active_elections.clone(),
            base_latency,
            aec_tx.clone(),
            scheduler_wake_policy.clone(),
        ));
        ...
        let aec_fact_processor = AecFactProcessor {
            ...
            online_reps: online_reps.clone(),
            active_elections: active_elections.clone(),
            wake_policy: scheduler_wake_policy.clone(),
